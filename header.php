...
<?php
$currentpagelink = get_page_link();
//echo gettype($currentpagelink);
$sub_str = substr($currentpagelink, 38);
$custom_body_class =  str_replace('/', '', $sub_str);
//echo $custom_body_class;
?>

<body <?php body_class($custom_body_class); ?> <?php neve_body_attrs(); ?>>
	<?php
	/**
			...
			?>
				<div class="custom-news">
					...
					<!-- <?php //dynamic_sidebar('Customsidebar'); 
							?> -->
					<div class="std-mod dropdown">
						<a class="sidebar-module dropbtn">Archives</a>
					...
					<!-- <div class="std-mod">
						<a class="sidebar-module" href="https://amerisource.webmasterindia.net/archive-news/"> Archives </a>
					</div> -->
				</div>
			<?
			}
